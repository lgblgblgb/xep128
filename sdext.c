...
{
	sdf = open_emu_file(SDCARD_IMG_FN, "rb");
	if (sdf == NULL) ERROR_WINDOW("SD card image file \"%s\" cannot be open: %s. You can use Xep128 but SD card access won't work!", SDCARD_IMG_FN, ERRSTR());
